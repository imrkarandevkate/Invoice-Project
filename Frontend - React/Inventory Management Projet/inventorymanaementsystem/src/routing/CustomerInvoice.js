...
export const CustomerInvoice = () => {
    ...
    const Viewinvoice = () => {
        ...
        axios({
            url: "http://localhost:9092/api/invoice/" + id,
            method: 'get',
        ...
        <diV>
            <div className="container-fluid">
                <div className="col-md-12 mt-4 d-flex">
                    <button className="btn p-3 btnback "><Link className="text-light p-3" style={{ backgroundColor: "#990000", textDecoration: "none" }} to="/route_invoice">Back</Link></button>
                    ...
                    <div className="card-header">
                        ...
                        <div className="card-header">
                            <div className="invoice-header d-flex p-3 " style={{ textAlignLast: "right" }}>
                                <div className="mt-2">
                                    <img src={Logo} className="img" style={{ height: "150px" }} />
                                </div>
                                <div className="ms-auto" style={{}}>
                                    <h1 ><b>Infiniti Tech</b></h1>

                                    <p><i class="fa fa-envelope" aria-hidden="true" /> &nbsp;infinititech@gmail.com</p>

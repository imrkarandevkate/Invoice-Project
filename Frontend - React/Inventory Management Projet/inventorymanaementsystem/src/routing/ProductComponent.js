...
export const Product = () => {
    ...
    const GetProduct = () => {
        axios({
            url: "http://localhost:9092/api/product",
            method: 'get',
            ...
            <div className="container-fluid">
                ...
                <div className=" container-fluid card mt-4">
                    ...
                    <div className="d-flex pt-2">
                        ...
                        <a href="#myModal" role="button" className="btn btn-primary ms-auto" data-bs-toggle="modal" style={{ background: "#4a47a3", color: "white" }}>Add New Product</a>
                    </div>
                    <hr />
                        ...
                        <div className="modal-dialog">
                            <div className="modal-content  ">
                                ...
                                <div className="modal-footer">
                                    <input type="button" className="btn btn-danger" data-bs-dismiss="modal" value="Cancel" onClick={() => ClearProduct()} />
                                    {showAddButton && (<input type="button" id="btnAdd" className="btn btn-primary" data-bs-dismiss="modal" onClick={() => AddProduct()} value="Add" />
                                    )}
                                    {showUpdateButton && (
                                        <input type="button" id="btnUpdate" className="btn btn-primary" value="Update" data-bs-dismiss="modal" onClick={() => UpdateProduct()} />
                                    )}
                                </div>
                            </div>
                        </div>

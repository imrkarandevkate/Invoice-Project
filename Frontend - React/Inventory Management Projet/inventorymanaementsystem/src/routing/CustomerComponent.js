...
export const Customer = () => {
    ...
    const GetCustomer = () => {
        axios({
            url: "http://localhost:9092/api/customer",
            method: 'get',
    ...
    const DeleteCustomer = (p) => {
        ...
        axios({
            url: "http://localhost:9092/api/customer/" + cid,
            method: "Delete",
            contentType: 'application/json',
        }).then(e => {
                ...
                <div className=" container-fluid card mt-4 mb-4">
                    <div className="customer p-1 ">
                        <div className="d-flex pt-2">
                            ...
                            <a href="#myModal" role="button" className="btn btn-primary ms-auto" data-bs-toggle="modal" style={{ background: "#4a47a3", color: "white" }}>Add New Customer</a>
                        </div>
                        <hr />
                            ...
                            <div className="modal-dialog">
                                <div className="modal-content">
                                    ...
                                    <div className="modal-footer">
                                        <input type="button" className="btn btn-danger" data-bs-dismiss="modal" value="Cancel" onClick={() => ClearCustomer()} />
                                        {showAddButton && (<input type="button" id="btnAdd" className="btn btn-primary" data-bs-dismiss="modal" onClick={() => AddCustomer()} value="Add" />
                                        )}
                                        {showUpdateButton && (
                                            <input type="button" id="btnUpdate" className="btn btn-primary" data-bs-dismiss="modal" onClick={() => UpdateCustomer()} value="Update" />
                                        )}
                                    </div>
                                </div>
                            </div>
